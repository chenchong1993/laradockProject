    ...
    function(Map, ArcGISDynamicMapServiceLayer,Extent, SpatialReference, Echarts3Layer, parser) {
        ...
        map = new Map("map", {
              center: [114.392, 37.95],
                zoom: 8,
                extent: new Extent(560012.888, 4239344.56, 561111.85, 4239623.311, new SpatialReference(4547)),
                logo:false
        });
        var floorMap = new ArcGISDynamicMapServiceLayer("http://61.240.144.70:5567/arcgis/rest/services/airport/airport_level1/MapServer");
        ...
        function getHeatMapData(){
            $.get("data/airport-floor1-heat-data.json",function(json){
            //设置常亮
