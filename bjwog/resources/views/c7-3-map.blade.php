  ...
  function init() {
    ...
    */
    ...
    require([
        ...
        //初始化F2楼层平面图
        var f1 = new DynamicMapServiceLayer("http://121.28.24.203:5567/arcgis/rest/services/C7/c7floor3/MapServer");
        map.addLayer(f1);

        //初始化路网
        var f2 = new DynamicMapServiceLayer("http://121.28.24.203:5567/arcgis/rest/services/C7/network3/MapServer");
        map.addLayer(f2);
